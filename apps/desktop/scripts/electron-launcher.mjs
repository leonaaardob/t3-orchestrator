// This file mostly exists because we want dev mode to say "T3 Orchestrator (Dev)" instead of "electron"
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "T3 Orchestrator (Dev)" : "T3 Orchestrator";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.t3orchestrator.app.dev.${devBundleIdSuffix || "local"}`
  : "com.t3orchestrator.app";
const APP_PROTOCOL_SCHEMES = isDevelopment ? ["t3orchestrator-dev"] : ["t3orchestrator"];
