...
const APP_BASE_NAME = "T3 Orchestrator";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "T3 Orchestrator (Dev)" : "T3 Orchestrator";
  ...
  return DesktopEnvironment.of({
    ...
    connectionCatalogPath: path.join(appDataDirectory, userDataDirName, "connection-catalog.json"),
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.t3orchestrator.app.dev" : "com.t3orchestrator.app",
    ),
    linuxDesktopEntryName: isDevelopment
      ? "t3-orchestrator-dev.desktop"
      : "t3-orchestrator.desktop",
    linuxWmClass: isDevelopment ? "t3-orchestrator-dev" : "t3-orchestrator",
