...
const ProjectionProjectDbRowSchema = ProjectionProject.mapFields(
  Struct.assign({
    ...
    agentExecutionPresets: Schema.NullOr(Schema.fromJsonString(AgentExecutionPresets)),
...
function mapSessionRow(
  ...
  return {
    ...
    autoWakePaused: row.autoWakePaused === 1,
...
function mapProjectShellRow(
  ...
  return {
    ...
    agentExecutionPresets: row.agentExecutionPresets,
    ...
    execute: () =>
      sql`
        SELECT
          ...
          agent_execution_presets_json AS "agentExecutionPresets",
    ...
    execute: () =>
      sql`
        SELECT
          ...
          auto_wake_paused AS "autoWakePaused",
          updated_at AS "updatedAt"
    ...
    execute: () =>
      sql`
        SELECT
          ...
          sessions.auto_wake_paused AS "autoWakePaused",
            ...
            : repositoryIdentityResolver.resolve(option.value.workspaceRoot).pipe(
                Effect.map((repositoryIdentity) =>
                  Option.some({
                    ...
                    agentExecutionPresets: option.value.agentExecutionPresets,
