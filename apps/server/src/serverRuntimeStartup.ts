...
import * as AgentBoardScheduler from "./agentBoard/Services/AgentBoardScheduler.ts";
...
>()("t3-orchestrator/serverRuntimeStartup") {}
...
export const make = (options?: StartupOptions) =>
  Effect.gen(function* () {
    ...
    const agentBoardScheduler = yield* AgentBoardScheduler.AgentBoardScheduler;
    ...
    const startup = Effect.gen(function* () {
      ...
      yield* runStartupPhase(
        ...
        Effect.gen(function* () {
          ...
          yield* agentBoardScheduler.start().pipe(Scope.provide(reactorScope));
        }),
      );
