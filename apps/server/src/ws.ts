    ...
    Effect.gen(function* () {
      ...
      return WsRpcGroup.of({
        ...
        [WS_METHODS.projectsLoadAgentBoard]: (input) =>
          observeRpcEffect(
            WS_METHODS.projectsLoadAgentBoard,
            agentBoardFileSystem.load(input).pipe(
              Effect.mapError(
                (cause) =>
                  new AgentBoardFileError({
                    message: `Failed to load agent board: ${cause.message}`,
                    cause,
                  }),
              ),
            ),
        ...
        [WS_METHODS.projectsSaveAgentBoard]: (input) =>
          observeRpcEffect(
            WS_METHODS.projectsSaveAgentBoard,
            agentBoardFileSystem.save(input).pipe(
              Effect.mapError(
                (cause) =>
                  new AgentBoardFileError({
                    message: `Failed to save agent board: ${cause.message}`,
                    cause,
                  }),
              ),
            ),
        ...
        [WS_METHODS.projectsClaimAgentBoardCard]: (input) =>
          observeRpcEffect(
            ...
            agentBoardFileSystem.claim(input).pipe(
              Effect.mapError(
                (cause) =>
                  new AgentBoardFileError({
