...
const DESKTOP_APP_ID = "com.t3orchestrator.app";
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
      ...
      protocols: [
        {
          ...
          schemes: ["t3orchestrator", "t3orchestrator-dev"],
        },
      ],
      ...(signed
        ? {
            ...
            entitlements: path.join(repoRoot, "apps/desktop/entitlements.mac.plist"),
            entitlementsInherit: path.join(repoRoot, "apps/desktop/entitlements.mac.inherit.plist"),
            notarize: true,
          }
        : {}),
    };
  ...
  if (platform === "linux") {
    buildConfig.linux = {
      target: [target],
      executableName: "t3-orchestrator",
      icon: "icons",
      category: "Development",
      // electron-builder turns these into MimeType=x-scheme-handler/<scheme>;
      // in the .desktop entry (Exec already gets %U), so browsers can hand
      // t3orchestrator:// OAuth callbacks to the app.
      protocols: [
        {
          name: "T3 Orchestrator",
          schemes: ["t3orchestrator", "t3orchestrator-dev"],
      ...
      desktop: {
        entry: {
          StartupWMClass: "t3-orchestrator",
        },
      },
    };
  }
